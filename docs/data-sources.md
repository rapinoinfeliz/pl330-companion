...
Balizas de radionavegação NDB mundiais vêm do arquivo diário `navaids.csv` do OurAirports, publicado em domínio público. Apenas NDBs dentro de 153–1.710 kHz entram no catálogo. WWV e WWVH usam as frequências publicadas pelo NIST. O guia de atividades usa o plano da IARU Região 2 e as frequências marítimas de segurança publicadas pela USCG, sempre como referência de escuta — não como garantia de atividade.
